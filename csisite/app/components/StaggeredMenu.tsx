...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    ...
    const animateIcon = useCallback((opening: boolean) => {
        ...
        if (opening) {
            gsap.to(line1, { rotate: 45, y: 6, duration: 0.3, ease: 'power2.out' });
            gsap.to(line2, { opacity: 0, duration: 0.2, ease: 'power2.out' });
            gsap.to(line3, { rotate: -45, y: -6, duration: 0.3, ease: 'power2.out' });
        } else {
            gsap.to(line1, { rotate: 0, y: 0, duration: 0.3, ease: 'power2.out' });
            gsap.to(line2, { opacity: 1, duration: 0.2, ease: 'power2.out' });
            gsap.to(line3, { rotate: 0, y: 0, duration: 0.3, ease: 'power2.out' });
        }
    }, []);
