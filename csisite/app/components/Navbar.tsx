...
function Navbar() {
  return (
    <motion.div className="hidden md:block w-full py-4 px-8 bg-black/40 overflow-hidden  border border-blue-400/40 shadow-md max-w-[80%] fixed bottom-0 z-50 rounded-2xl mx-auto left-0 right-0 mb-4 " 
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div>
          ...
          <a href="/join-us" className="mx-4 text-white hover:text-blue-600">
            Join Us
          </a>
