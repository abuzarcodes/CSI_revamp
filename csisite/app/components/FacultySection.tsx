...
function FacultySection() {
  return (
    <div className="bg-black w-full h-screen flex flex-col gap-y-10 justify-center items-center">
      <h1 className=" uppercase tracking-[20px] text-blue-500 text-[5vw] text-center md:text-4xl font-extralight">
        Faculty Advisor
      </h1>
      <FacultyCard
...
function FacultyCard({ name, position, image, description }: FacultyCardProps) {
  return (
    <motion.div
      ...
      className="relative max-w-5xl mx-4 md:mx-auto bg-[#0a0a0a] border border-blue-500/25 px-8 py-10 shadow-2xl shadow-blue-500/15 "
    >
      {/* Top academic stripe */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-10 items-center">
        ...
        <div className=" md:col-span-3">
          ...
          <h3 className="mt-3 text-[5vw] md:text-3xl font-semibold text-white">
            {name}
          </h3>
